...
//		assertEquals(getType(number), char.class);
	...
	public void charsCanOnlyBePositive() {
		...
		assertEquals((int) Character.MAX_VALUE, (int) 65535);
...
//		assertEquals(getType(1.0), ;);
	...
	public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
		...
		assertEquals(1.0e3, (double) 1000.0);
		assertEquals(1E3, (double) 1000.0);
	}
